...
import {getRandomAction, FlyGame, NUM_ACTIONS, ALL_ACTIONS, getStateTensor} from './game';
import {ReplayMemory} from './replay_memory';
import { assertPositiveInteger } from './utils';


export class FlyGameAgent{
   ...
   */
    playStep() {
        ...
        const {state: nextState, reward, done, score} = this.game.step(action);
